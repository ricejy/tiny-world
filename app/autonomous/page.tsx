...
export default function Autonomous(){
  ...
  function intervene(task:Task){const s=simRef.current;if(['won','lost'].includes(s.status))return;cancelRequest();const next=assignDecisions({...s,status:'running'},{[override]:task});commit({...next,status:s.status});lastDecision.current=s.time;}
